    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 py-16">
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-100 mb-6" data-testid="text-bio-heading">
            About Me
          </h1>
          {/* CHANGED: Added dark:text-gray-400 */}
          <p className="text-xl text-academic-gray dark:text-gray-400" data-testid="text-bio-subtitle">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2 space-y-8">
            <div data-testid="section-background">
              {/* CHANGED: Added dark:text-gray-100 */}
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Background</h2>
            ...
            <div data-testid="section-education">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    {/* CHANGED: Added dark:text-gray-100 */}
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">PhD in Mathematics (Statistical Genetics)</h3>
                    {/* CHANGED: Added dark:text-gray-400 */}
                    <p className="text-academic-gray dark:text-gray-400">Indian Institute of Technology Hyderabad (IIT Hyderabad)</p>
                ...
                <div className="flex items-start space-x-4">
                  <GraduationCap className="w-6 h-6 text-academic-blue mt-1" />
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Master of Science in Statistics</h3>
                    <p className="text-academic-gray dark:text-gray-400">University of Lucknow</p>
                    <div className="flex items-center text-sm text-gray-500 dark:text-gray-500 mt-1">
                      <Calendar className="w-4 h-4 mr-1" />
                      <span>2018 - 2020</span>
                    </div>
                ...
                <div className="flex items-start space-x-4">
                  <GraduationCap className="w-6 h-6 text-academic-blue mt-1" />
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Bachelor of Science</h3>
                    <p className="text-academic-gray dark:text-gray-400">University of Lucknow</p>
                    <div className="flex items-center text-sm text-gray-500 dark:text-gray-500 mt-1">
                      <Calendar className="w-4 h-4 mr-1" />
                      <span>2015 - 2018</span>
            ...
            <div data-testid="section-interests">
              {/* CHANGED: Added dark:text-gray-100 */}
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Research Interests</h2>
              <div className="grid md:grid-cols-2 gap-4">
                {/* CHANGED: Added dark:bg-gray-800 to all interest cards */}
                <div className="bg-academic-light dark:bg-gray-800 p-4 rounded-lg">
                  {/* CHANGED: Added dark:text-gray-100 */}
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Statistical Genetics</h3>
                  {/* CHANGED: Added dark:text-gray-300 */}
                ...
                <div className="bg-academic-light dark:bg-gray-800 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Gene-Environment Interactions</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Investigating how genetic variants interact with environmental factors in complex traits
                  </p>
                </div>
                <div className="bg-academic-light dark:bg-gray-800 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">TWAS Methodology</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
                    Transcriptome-wide association studies to understand gene expression and disease susceptibility
                  </p>
                </div>
                <div className="bg-academic-light dark:bg-gray-800 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Computational Biology</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div data-testid="section-awards">
              {/* CHANGED: Added dark:text-gray-100 */}
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-6">Awards & Honors</h2>
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  <Award className="w-5 h-5 text-yellow-500 mt-1" />
                  <div>
                    {/* CHANGED: Added dark:text-gray-100 */}
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100">GATE (Statistics) Fellowship</h3>
                    {/* CHANGED: Added dark:text-gray-300 */}
                    <p className="text-gray-600 dark:text-gray-300 text-sm">Ministry of Education, GoI</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <Award className="w-5 h-5 text-yellow-500 mt-1" />
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100">CSIR-NET (Mathematical Science)</h3>
                    <p className="text-gray-600 dark:text-gray-300 text-sm">Council of Scientific and Industrial Research, 2022</p>
                  </div>
                </div>
                {/* <div className="flex items-start space-x-4">
                  <Award className="w-5 h-5 text-yellow-500 mt-1" />
